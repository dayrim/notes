export default [
  {
    "statements": [
      ...
      "CREATE TRIGGER insert_main_note_into_oplog\n   AFTER INSERT ON \"main\".\"note\"\n   WHEN 1 == (SELECT flag from _electric_trigger_settings WHERE tablename == 'main.note')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES ('main', 'note', 'INSERT', json_object('id', new.\"id\"), json_object('content', new.\"content\", 'createDate', new.\"createDate\", 'id', new.\"id\", 'title', new.\"title\", 'updateDate', new.\"updateDate\"), NULL, NULL);\nEND;",
      "DROP TRIGGER IF EXISTS update_main_note_into_oplog;",
      "CREATE TRIGGER update_main_note_into_oplog\n   AFTER UPDATE ON \"main\".\"note\"\n   WHEN 1 == (SELECT flag from _electric_trigger_settings WHERE tablename == 'main.note')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES ('main', 'note', 'UPDATE', json_object('id', new.\"id\"), json_object('content', new.\"content\", 'createDate', new.\"createDate\", 'id', new.\"id\", 'title', new.\"title\", 'updateDate', new.\"updateDate\"), json_object('content', old.\"content\", 'createDate', old.\"createDate\", 'id', old.\"id\", 'title', old.\"title\", 'updateDate', old.\"updateDate\"), NULL);\nEND;",
      "DROP TRIGGER IF EXISTS delete_main_note_into_oplog;",
      "CREATE TRIGGER delete_main_note_into_oplog\n   AFTER DELETE ON \"main\".\"note\"\n   WHEN 1 == (SELECT flag from _electric_trigger_settings WHERE tablename == 'main.note')\nBEGIN\n  INSERT INTO _electric_oplog (namespace, tablename, optype, primaryKey, newRow, oldRow, timestamp)\n  VALUES ('main', 'note', 'DELETE', json_object('id', old.\"id\"), NULL, json_object('content', old.\"content\", 'createDate', old.\"createDate\", 'id', old.\"id\", 'title', old.\"title\", 'updateDate', old.\"updateDate\"), NULL);\nEND;"
    ],
    "version": "1"
  }
]